...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    public void openORstopemployee(Integer status,Integer id) {
        employeeMapper.openORstopemployee(status,id);
    }
    ...
    public void updateEmployee(EmployeeDTO employeeDTO) {
        ...
        employeeMapper.updateEmployee(employeeDTO,updateUser,updateTime);
    }
